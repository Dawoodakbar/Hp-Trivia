...
struct Gameplay: View {
    ...
    @State private var wrongeAnswersTapped : [Int] = []
            ...
            ZStack {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .animation(
                            .easeOut(duration: animateViewsIn ? 1.5 : 0).delay(animateViewsIn ? 2 : 0),
                            value: animateViewsIn
                        )
                    }
                    .padding(.bottom)
                        ...
                        columns: [GridItem(), GridItem()]) {
                            ForEach(1..<5){ i in
                                if tempAnswers[i-1] {
                                    ...
                                    .animation(
                                        .easeOut(duration: animateViewsIn ? 1 : 0)
                                    ...
                                    VStack {
                                        if animateViewsIn {
                                            Text("Answer \(i)")
                                                ...
                                                .disabled(
                                                    tappedCorrectAnswer || wrongeAnswersTapped
                                                        .contains(i)
                                                )
                                                .opacity(tappedCorrectAnswer ? 0.1 : 1)
                                        }
                ...
                VStack {
                    ...
                    .animation(
                        .easeInOut(duration:tappedCorrectAnswer ? 1 : 0).delay(tappedCorrectAnswer ? 2 : 0),
